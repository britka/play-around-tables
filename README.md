...
```
cd existing_repo
git remote add origin https://gitlab.com/sbrit1/play-around-tables.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sbrit1/play-around-tables/-/settings/integrations)
